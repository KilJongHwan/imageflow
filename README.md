...
- Backend: `https://imageflow-backend-kdt1.onrender.com`
- API Docs: `https://imageflow-backend-kdt1.onrender.com/swagger-ui`
...
5. `https://imageflow-backend-kdt1.onrender.com/swagger-ui`
   - API 문서와 엔드포인트 구성 확인
6. `https://imageflow-backend-kdt1.onrender.com/api/health`
